                        ...
                        <div class="col-md-3">
                            <div class="card card-default card-product">
                                <div class="card-header">
                                    <h3 class="card-title">
                                        <?=$category['cat_title'];?></h3>
                                    <a class="external-link fa fa-external-link-alt" target="_blank" href="/categories/<?=$category['cat_alias'];?>"></a>
                                </div>

                                <div class="card-body">
                                    <a class="product-card_cover" href="/admin/categories/<?=$category['cat_id'];?>">
